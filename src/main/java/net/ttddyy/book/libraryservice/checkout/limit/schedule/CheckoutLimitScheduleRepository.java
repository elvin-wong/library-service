 ...
 */
@Repository
public interface CheckoutLimitScheduleRepository extends JpaRepository<CheckoutLimitSchedule, Long>,
		ListPagingAndSortingRepository<CheckoutLimitSchedule, Long> {
