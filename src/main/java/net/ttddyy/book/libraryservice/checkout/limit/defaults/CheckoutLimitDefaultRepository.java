 ...
 */
@Repository
public interface CheckoutLimitDefaultRepository
		extends JpaRepository<CheckoutLimitDefault, Long>, ListPagingAndSortingRepository<CheckoutLimitDefault, Long> {
